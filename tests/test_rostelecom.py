...
def test_contents_RT_page(driver):
    page = AuthPage(driver)
    page.driver.save_screenshot('RT_page.png')


def test_RT_with_correct_data(driver):
    page = AuthPage(driver)
...
def test_RT_with_incorrect_email(driver):
    page = AuthPage(driver)
...
def test_RT_with_incorrect_pass(driver):
    page = AuthPage(driver)
    page.enter_email('makar_85@mail.ru')
